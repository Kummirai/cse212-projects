public static class DisplaySums
{
    ...
    private static void DisplaySumPairs(int[] numbers)
    {
        ...
        //1. Create loop to go iterate through the numbers
        //2. Create an set that stores the number pairs
        //3. check if current number when combined with another number in the array we get the sum of 10
