public static class Divisors
{
    ...
    private static List<int> FindDivisors(int number)
    {
        ...
        // 1. Create a for loop and loop from 1 to number-1 to find all divisors of 'number'
        // 2. Check if 'i' divides evenly into 'number' (remainder is 0)
        // 3. If it's a divisor, add it to the results list
        // 4. Return the list containing all found divisors
